...
namespace FuarYonetimSistemi.Infrastructure.Migrations
{
    ...
    [Migration("20250603000530_brand")]
    partial class brand
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FuarYonetimSistemi.Domain.Entities.ParticipantBrand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ParticipantBrands");
                });

            modelBuilder.Entity("FuarYonetimSistemi.Domain.Entities.ParticipantProductGroup", b =>
                {
                    b.Property<Guid>("ParticipantId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ParticipantId", "ProductGroupId");

                    b.HasIndex("ProductGroupId");

                    b.ToTable("ParticipantProductGroups");
                });
            ...
            modelBuilder.Entity("FuarYonetimSistemi.Domain.Entities.ProductGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FuarYonetimSistemi.Domain.Entities.ParticipantProductGroup", b =>
                {
                    b.HasOne("FuarYonetimSistemi.Domain.Entities.Participant", "Participant")
                        .WithMany("ParticipantProductGroups")
                        .HasForeignKey("ParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FuarYonetimSistemi.Domain.Entities.ProductGroup", "ProductGroup")
                        .WithMany("ParticipantProductGroups")
            ...
            modelBuilder.Entity("FuarYonetimSistemi.Domain.Entities.Participant", b =>
                {
                    ...
                    b.Navigation("ParticipantBrands");

                    b.Navigation("ParticipantProductGroups");
