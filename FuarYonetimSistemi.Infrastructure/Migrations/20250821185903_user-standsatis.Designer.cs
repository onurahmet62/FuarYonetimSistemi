...
namespace FuarYonetimSistemi.Infrastructure.Migrations
{
    ...
    [Migration("20250821185903_user-standsatis")]
    partial class userstandsatis
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FuarYonetimSistemi.Domain.Entities.Stand", b =>
                {
                    ...
                    b.HasIndex("FairId", "SalesRepresentativeId")
                        .HasDatabaseName("IX_Stands_Fair_SalesRep");

                    b.HasIndex("SalesRepresentativeId", "ContractDate")
            ...
            modelBuilder.Entity("FuarYonetimSistemi.Domain.Entities.Stand", b =>
                {
                    ...
                    b.HasOne("FuarYonetimSistemi.Domain.Entities.User", "SalesRepresentative")
                        .WithMany()
